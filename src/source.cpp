...
void main(int argc, char* argv[])
{
	...
	CCamera* camera1 = new CCamera(500, 400, vec3(3, 15, -16), vec3(0, 0, 0), vec3(0, 1, 0), 50.f);
	...
	/* Odwrócony Y!!!! */
	//objVec1.push_back(new CTriangle(vec3(-7, -4, -7), vec3(-7, -4, 7), vec3(7, -4, 7), 1.f, vec3(0.01, 0.01, 0.01), vec3(0.01, 0.01, 0.6), vec3(0.01, 0.01, 0.01), 20.f));
	//objVec1.push_back(new CTriangle(vec3(7, -4, 7), vec3(7, -4, -7), vec3(-7, -4, -7), 1.f, vec3(0.01, 0.01, 0.01), vec3(0.01, 0.01, 0.6), vec3(0.01, 0.01, 0.01), 20.f));
